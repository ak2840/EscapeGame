...
const GAME_CONFIG = {
  gameInfo: {
    ...
    version: "1.0.0",
    description: "為什麼只有一格",
    instructions: ["使用方向鍵移動，抵達電信塔時請按空白鍵完成任務。蹲下可降低追蹤風險。", "電腦裝置可提供完整視聽體驗，行動裝置亦支援存活行動。", "若基地靜默無聲，請手動開啟聲音。首次以行動裝置登入時，音效已預設關閉，防止系統過載。"],
    uiText: {
      continue: "按空白鍵繼續",
    ...
    controls: ["方向鍵：移動", "空白鍵：執行動作", "• 停止時自動攻擊", "• 找到綠色出口通關", "• 安全區域內無敵", "• 普通怪物會冰凍玩家（減緩80%移動速度，持續5秒）", "• 血量耗盡遊戲結束"],
    monsterDescriptions: ["• 橙色/紫色/綠色：普通怪物（冰凍效果）", "• 粉色：追蹤怪物（造成傷害）", "• 深紅：砲塔怪物（造成傷害）", "• 玩家在安全區時不攻擊"],
  },
  maxLevel: 4,
  defaultSettings: {
    playerSpeed: 4,
