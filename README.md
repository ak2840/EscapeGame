...
├── index.html              # 主頁面
├── main.js                 # 遊戲核心邏輯
├── levelConfig.json        # 遊戲配置
├── README.md              # 專案說明
├── CONFIG_README.md       # 配置說明
├── WEIGHT_SYSTEM_README.md # 權重系統說明
├── Run.command            # 快速啟動腳本
└── assets/                # 資源檔案
    ├── audio/             # 音效檔案
    ├── maps/              # 地圖圖片
...
### 權重系統
地圖圖片支援權重配置，詳細說明請參考 [WEIGHT_SYSTEM_README.md](WEIGHT_SYSTEM_README.md)
...
### 修改遊戲平衡
1. 編輯 `levelConfig.json`
2. 調整怪物數量、血量、速度
3. 修改遊戲時間和道具要求
4. 測試遊戲平衡性

### 添加新關卡
1. 在 `levelConfig.json` 中添加新關卡配置
2. 準備對應的地圖圖片
3. 設定怪物分布和道具要求
4. 更新 `maxLevel` 值
